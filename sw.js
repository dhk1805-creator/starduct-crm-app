/* ==========================================================================
   Service Worker — CRM Starduct (PWA v22)
...
const SHELL = [
  ...
  './js/10-du-an-tiep-xuc.js', './js/11-import.js', './js/12-hybrid.js', './js/13-du-an-hop-nhat.js', './js/14-npp-taikhoan.js', './js/15-auth-hop-nhat.js', './js/16-mobile.js', './js/17-nganh-hang-kh.js'
];
